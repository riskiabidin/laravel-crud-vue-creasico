            ...
            <form @submit.prevent="createPembelian">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select v-model="form.id_supplier" class="form-control select2" style="width: 100%;">
                            <option v-for="supplier in suppliers.data" :value="supplier.id">
                                {{ supplier.name_supplier }}
                            </option>
                        </select>
                        <div class="text-danger" v-if="errors.id_supplier">{{ errors.id_supplier }}</div>
                    </div>
                    <div class="form-group">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="detail in form.detail">
                                <th scope="row"></th>
                                ...
                                <td>
                                    <a href="#" @click="editDetail()">
                                        <i class="fa fa-edit blue"></i>
                                    </a>
                                    /
                                    <a href="#" @click="deleteDetail()">
                            ...
                            <form @submit.prevent="editmode ? updateDetail() : createDetail()">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select required @change="detail()" v-model="form2.id_produk" class="form-control select2"
                                            style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled v-model="form2.harga_beli" type="number" class="form-control"
                                            placeholder="Input harga beli">
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah:</label>
                                        <input @click="hitungSubTotal()" @keyup="hitungSubTotal()" v-model="form2.jumlah" type="number" class="form-control"
    ...
    methods: {
        detail(){
            for(let i=0;i<this.produks.data.length;i++){
                ...
                console.log(this.form2.harga_beli);
            }
        },
        hitungSubTotal(){
            this.form2.sub_total=this.form2.harga_beli*this.form2.jumlah;
        },
        hitungTotalHarga(){
